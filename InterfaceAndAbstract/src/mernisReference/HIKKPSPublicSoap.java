...
public class HIKKPSPublicSoap
{
    ...
    public HIKKPSPublicSoap(){}

    public HIKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HIKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HIKExtendedSoapSerializationEnvelope envelope= new HIKExtendedSoapSerializationEnvelope(HIKExtendedSoapSerializationEnvelope.VER11);
