...
public class HIKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HIKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HIKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HIKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HIKDateTimeConverter dateTimeConverter = new HIKStandardDateTimeConverter();

    public HIKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HIKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HIKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HIKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HIKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HIKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
